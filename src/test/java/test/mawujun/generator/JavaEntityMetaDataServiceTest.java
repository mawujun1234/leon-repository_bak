...
public class JavaEntityMetaDataServiceTest {
	...
	public void test1 (){
		...
		assertEquals(new Integer(0), id.getPrecision());
		assertEquals(new Integer(0), id.getScale());
		...
		assertEquals(new Integer(0), sex.getPrecision());
		assertEquals(new Integer(0), sex.getScale());
	...
	public void test2 (){
		...
		assertEquals(false, id.getIsEnum());
		assertEquals("java.lang", id.getBasepackage());
		assertEquals("java.lang.Long", id.getClassName());
		assertEquals("Long", id.getSimpleClassName());
		assertEquals(true,id.getIsId());
		assertEquals(IDGenEnum.uuid,id.getIdGenEnum());
		
		assertEquals(Long.class,root.getIdClass());
		assertEquals("id", root.getIdPropertys()[0]);
		assertEquals("id", root.getIdColumns()[0]);
		assertEquals(null, root.getIdSequenceName());
